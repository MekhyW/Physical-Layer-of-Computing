...
def validatePackage(package : Datagram, restartPackage, lastValidatedPackage = 0):
    if package.head.h3 == "00" or package.head.h4 == "00" or package.head.h6 == "00":
        ...
        if (len(package.payload) == int(package.head.h5)):
            if package.head.h0 == "03" :
                ...
                if lastValidatedPackage != 0:
                    ...
                    print("Erro: Pacote inválido - índice do último pacote verificado incorreto")
                    return False
            elif package.head.h0 == "05":
                print("Pacote válido")
                return True
            elif package.head.h0 == "06":
                if int(package.head.h6) == restartPackage:
                    print("Pacote válido")
                    return True
                else:
